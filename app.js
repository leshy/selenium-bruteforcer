...
(function(){
  var fs, path, colors, webdriverio, events, p, h, _, options, Reader, BruteForcer, bruteForcer, workerN, spawnWorker;
  fs = require('fs');
  path = require('path');
  ...
  spawnWorker = function(){
    ...
    return page.timeoutsImplicitWait(200).url('http://192.168.5.1').title(function(err, res){
      return console.log('title: ' + res.value);
    }).bruteforce(bruteForcer).then(function(it){
